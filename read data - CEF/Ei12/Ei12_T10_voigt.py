...
# params['l1_fwhm'].set(ins_res_12(4.779),vary=False)
# params['l1_gamma'].set(0.1,min=0)

print('instrument resolution of peqk 1: {}'.format(ins_res_12(4.984)))
print('instrument resolution of peqk 1: {}'.format(ins_res_12(7.9597)))

params['l1_amplitude'].set(0.001,min=0)
params['l1_mean'].set(8)
params['l1_fwhm'].set(ins_res_12(7.929),vary=False)
params['l1_gamma'].set(0.1)
...
ax2.errorbar(x_fit,y_fit-comps['bg_'],yerr = err_q,marker='.', ls='none', mfc='None', label='data')
...
fit_gamma = result.values['l1_gamma']
sim_int_40_3p32 = 0.00273018*TVS.normalizedNeutronSpectrum(x_1, Temp=10, ResFunc=ins_res_3p32,gamma=fit_gamma)
sim_int_40_12 = 0.00273018*TVS.normalizedNeutronSpectrum(x_2, Temp=10, ResFunc=ins_res_12,gamma=fit_gamma)
