...
B60 = 2.31716153e-06
# B66List=[0]
B66List=[0,-1.64771401e-06,3e-5]
# [-1.02994297e-01 -5.94668808e-04  2.31716153e-06 -1.64771401e-06]
...
#
    ...
    # sim_int_40 = 0.00250932 * TVS.normalizedNeutronSpectrum(xx, Temp=60, ResFunc=ins_res)+6.7776e-04
    sim_int_40 = TVS.normalizedNeutronSpectrum(xx, Temp=60, ResFunc=ins_res)
    ...
    ax3.set_xlim(left=0,right=20)
    ax3.set_ylim(bottom=-0.1,top=40)
    ax3.set_title('resolution is 0.1')
