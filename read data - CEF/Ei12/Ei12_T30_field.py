...
params['l1_mean'].set(4.8)
params['l1_fwhm'].set(ins_res_12(4.894),vary=False)
params['l1_gamma'].set(0.25)

params['l2_amplitude'].set(0.001,min=0)
params['l2_mean'].set(7.8)
params['l2_fwhm'].set(ins_res_12(7.961),vary=False)
params['l2_gamma'].set(0.25)

params['l3_amplitude'].set(expr='l1_amplitude')
params['l3_mean'].set(5)
params['l3_fwhm'].set(ins_res_12(4.894),vary=False)
params['l3_gamma'].set(0.2)

params['l4_amplitude'].set(expr='l2_amplitude')
params['l4_mean'].set(8)
params['l4_fwhm'].set(ins_res_12(7.961),vary=False)
params['l4_gamma'].set(0.2)
...
# gamma_12 = [0.322520, 0.2850965, 0.3430645, 0.395609]
gamma_3 = [0.563855,0.166451, 0.225229,0.283669]
# gamma_12 = [0.214231, 0.143924, 0.2075815, 0.253425]
gamma_12 = [0.214231, 0.143924, 0.2075815, 0.224838]
...
sim_int_40_3p32 = 0.0022*TVS.normalizedNeutronSpectrum(x_1, Temp=30, ResFunc=ins_res_3p32,gamma=gamma_3[3])
sim_int_40_12 = ratio*0.0022*TVS.normalizedNeutronSpectrum(x_2, Temp=30, ResFunc=ins_res_12,gamma=gamma_12[3])
...
slope = (sumII_q[-1] - sumII_q[0]) / (x_e[-1] - x_e[0])
intercept = sumII_q[0] - x_e[0] * slope
bg_12 = linear(x_e, slope, intercept)

ax3.errorbar(x_e, sumII_q-bg_12, err_q, marker='.', ls='none', fmt='o-', mfc='None', label='data')
