...
for idx, t in enumerate(t_list):
    ...
    FittedSpectrum2 = FitCoefRes1['ratio']*spectrum(TVS,x_e_3, Temp=t,ResFunc=ins_res_1p55,gamma=0) * FitCoefRes1['prefactor']
...
plt.legend(loc='best',fontsize=18,ncol=2,handletextpad=0.01,columnspacing=0.3)
plt.tight_layout()
