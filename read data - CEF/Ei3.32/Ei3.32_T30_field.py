...
params['v1_fwhm'].set(ins_res_3p32(0.680830), vary=False)
# params['v1_fwhm'].set(0.2)
params['v1_gamma'].set(0.18)

params['v2_amplitude'].set(0.005, min=0)
params['v2_mean'].set(1.2)
params['v2_fwhm'].set(ins_res_3p32(1.251857), vary=False)
# params['v2_fwhm'].set(0.2)
params['v2_gamma'].set(0.2)

params['v3_amplitude'].set(0.004, min=0)
params['v3_mean'].set(1.65)
params['v3_fwhm'].set(ins_res_3p32(1.693019), vary=False)
# params['v3_fwhm'].set(0.2)
params['v3_gamma'].set(0.2)

# params['v2_gamma'].set(expr='(v1_gamma+v3_gamma)/2')

params['v4_amplitude'].set(expr='v1_amplitude')
params['v4_mean'].set(0.8)
params['v4_fwhm'].set(ins_res_3p32(0.829448),vary=False)
# params['v4_fwhm'].set(expr='v1_fwhm')
params['v4_gamma'].set(0.2)

params['v5_amplitude'].set(expr='v2_amplitude')
params['v5_mean'].set(1.3)
params['v5_fwhm'].set(ins_res_3p32(1.472963),vary=False)
# params['v5_fwhm'].set(expr='v2_fwhm')
params['v5_gamma'].set(expr='v2_gamma')

params['v6_amplitude'].set(expr='v3_amplitude')
params['v6_mean'].set(1.75)
params['v6_fwhm'].set(ins_res_3p32(1.819251),vary=False)
# params['v6_fwhm'].set(expr='v3_fwhm')
params['v6_gamma'].set(0.2)
...
TVS.H += g * muB * mJ * field_guess
TVS.diagonalize()
print('---------wave function after applied field --------------')
TVS.printEigenvectors()
x_1 = np.linspace(0,3.32,1000)
x_2 = np.linspace(3.32,12,1000)
sim_int_30_3p32 = 0.0022*TVS.normalizedNeutronSpectrum(x_1, Temp=30, ResFunc=ins_res_3p32,gamma=gamma_3[3])
sim_int_30_12 = 0.0022*TVS.normalizedNeutronSpectrum(x_2, Temp=30, ResFunc=ins_res_12,gamma=gamma_12[3])
ax3.plot(x_1, sim_int_30_3p32, label='parameter1_40K_B66{}'.format(B66), marker='.',markersize=2)
ax3.plot(x_2, sim_int_30_12, label='parameter1_40K_B66{}'.format(B66), marker='.',markersize=2)
...
bg_3 = lorentzian_bg(x_e, *exp_bg[0])

ax3.errorbar(x_e, sumII_q, err_q, marker='.', ls='none', fmt='o-', mfc='None', label='data')
