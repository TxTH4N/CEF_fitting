...
params['bg_amplitude'].set(4,min=0)
params['bg_mean'].set(0)
params['bg_gamma'].set(0.004)
params['bg_const'].set(0.0)

params['g1_area'].set(0.000019)
params['g1_mean'].set(1.54)
params['g1_fwhm'].set(0.05)

# params['g2_area'].set(0.000019,min=0)
# params['g2_mean'].set(1.38)
# params['g2_fwhm'].set(0.05)
