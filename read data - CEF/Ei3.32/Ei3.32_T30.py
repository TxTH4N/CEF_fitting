...
def lorentzian(x, area, mean, fwhm):
    gamma= fwhm
    y = area / np.pi*0.5*gamma/((x-mean)**2+(0.5*gamma)**2)
    return y
...
for i in range(num_of_peaks):
    fmod += Model(gaussian, prefix='g{}_'.format(i + 1))
    # fmod += Model(lorentzian, prefix='g{}_'.format(i + 1))
params = fmod.make_params()
print('************************************')
print('Start fitting...')
print(f'Parameter names: {fmod.param_names}')

# params['bg_amplitude'].set(3.944630)
params['bg_amplitude'].set(4)
# params['bg_amplitude'].set(vary=False)
params['bg_mean'].set(0)
# params['bg_gamma'].set(0.001277)
params['bg_gamma'].set(0.004)
# params['bg_gamma'].set(vary=False)
params['bg_const'].set(0.0)

params['g1_area'].set(0.001)
params['g1_mean'].set(0.7)
params['g1_fwhm'].set(0.2)

params['g2_area'].set(0.001)
params['g2_mean'].set(1.25)
params['g2_fwhm'].set(0.2)

params['g3_area'].set(0.001)
params['g3_mean'].set(1.8)
params['g3_fwhm'].set(0.2)

# params['g4_area'].set(0.001)
# params['g4_mean'].set(1.65)
# params['g4_fwhm'].set(expr="g1_fwhm")
#
# params['g5_area'].set(0.001)
# params['g5_mean'].set(1.8)
# params['g5_fwhm'].set(expr="g1_fwhm")
...
for i in range(num_of_peaks):
    ax2.plot(x_fit, comps['g{}_'.format(i+1)], label=r'Gaussian #{}'.format(i+1))
