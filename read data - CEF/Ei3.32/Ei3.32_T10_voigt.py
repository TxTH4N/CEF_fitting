...
ax1.set_ylim(top=0.004,bottom=0)
...
params['v1_mean'].set(1.4)
params['v1_fwhm'].set(ins_res_3p32(1.38),vary=False)
params['v1_gamma'].set(0.0)

# params['v2_amplitude'].set(0.005,min=0)
# params['v2_mean'].set(1.540324,vary=False)
# params['v2_fwhm'].set(ins_res_3p32(1.540324),vary=False)
# params['v2_gamma'].set(0)
