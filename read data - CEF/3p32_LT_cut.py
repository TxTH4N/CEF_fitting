...
path_w = "/Users/tianxionghan/research/CEF_cal/CrystalFieldCal/plots/LTcut_3p32meV_ascii/"

for i_T,T in enumerate(T_list):
    output_path = path_w + "LTcut_3p32_{}K.txt".format(T)
    print(output_path)
    ...
    #     f.write(f'#E (meV)\t Intensity\terr_II\n')
    #     for x_e, sumII_q, err_q in zip(x_e, sumII_q, err_q):
    #         f.write(f'{x_e}\t{sumII_q}\t{err_q}\n')
ax1.set_xlabel('$\\hbar \\omega$ (meV)',fontsize=15)
ax1.set_ylabel('$\\rm I$ (a.u.)',fontsize=15)
...
# ax2.set_ylabel('$\\rm I$ (a.u.)', fontsize=10)
...
plt.show()
# plt.savefig("../plots/LTcut_3p32meV",dpi=300)
